...
class SECTools():
    ...
    def search_10q(stock):
        ...
        answer = SECTools.__embedding_search(link, stock)
        print(answer)
        return answer
    ...
    def __embedding_search(url, ask):
        ...
        vectorstore = LanceDB.from_documents(
            docs, embedding=embedding_function, connection=table)
        retriever = vectorstore.similarity_search(ask)
